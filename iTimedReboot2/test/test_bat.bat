...
call:mylog "======================================================"
call:mylog " TEST1..."
call:mylog "    test systemzeit vor rebootzeit"
call:mylog "======================================================"
rem setze system datum auf 10.11.2013
rem setze system zeit auf 14:00
SET systime=201311101400
call:mysetdatetime %systime%
rem setze daysinterval auf 1
set mydayinterval=1
rem setze lastrebootdate auf 10.11.2013, next reboot waere dann am 11.11.2013 15:00
set mylastreboot=20131110
...
call:mylog "======================================================"
call:mylog " TEST2..."
call:mylog "    test systemzeit nach rebootzeit"
call:mylog "======================================================"
rem setze system datum auf 11.11.2013
rem setze system zeit auf 16:00
SET systime=201311111600
call:mysetdatetime %systime%
rem setze daysinterval auf 1
set mydayinterval=1
rem setze lastrebootdate auf 10.11.2013, next reboot waere dann am 11.11.2013 15:00
...
call:mylog "======================================================"
call:mylog " TEST4..."
call:mylog "   test systemzeit zu 2 minuten nach rebootzeit"
call:mylog "======================================================"
rem setze system datum auf 11.11.2013
rem setze system zeit auf 15:02
SET systime=201311111502
call:mysetdatetime %systime%
rem setze daysinterval auf 1
set mydayinterval=1
rem setze lastrebootdate auf 10.11.2013, next reboot waere dann am 11.11.2013 15:00
